    ...
    <div>
      <Container>
        ...
        <Row className="about_row">
          ...
          <Col sm="3">
            <img className="about_image" align="right" src={logo2} alt={logo2}></img>
          </Col>
          <Col sm="3">
            <p className="header_sub abouts_text">신선한 재료</p>
            <p className="p_number abouts_text">1.</p>
        ...
        <Row className="about_row">
          ...
          <Col sm="3">
            <img className="about_image" src={logo3} alt={logo3}></img>
          </Col>
          <Col sm="3">
          </Col>
        </Row>
        ...
        <Row className="about_row">
          ...
          <Col sm="3">
            <img className="about_image" align="right" src={logo4} alt={logo4}></img>
          </Col>
          <Col sm="3">
            <p className="header_sub abouts_text">퀵 배송</p>
            <p className="p_number abouts_text">3.</p>
            <p className="des abouts_text">듣는다 그것은 웅대한 관현악이며 미묘한 교향악이다 뼈 끝에 스며들어 가는 열락의 소리다이것은 피어나기 전인 유소년에게서 구하지 못할 바이며 시들어 가는 노년에게.</p>
          </Col>
          <Col sm="3">
          </Col>
